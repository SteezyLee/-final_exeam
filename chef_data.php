...
<body>
	...
	<h1 align="center" valign="center">廚師資訊區-訂單資訊</h1>
	...
	<div class="btn-group-vertical" role="group" aria-label="Vertical button group" style="position: absolute; width:260px; right: -300px; top: 200px;" valign="center">
  	<a href="chef_data_menu.php"><button type="button" class="btn btn-dark">查看菜單資訊</button></a>
	<a href="chef_data_order_alter.php"><button type="button" class="btn btn-dark">修改訂單狀態</button></a>
	<a href="restaurant_system.php"><button type="button" class="btn btn-dark" name="log_out">登出</button></a>
	</div>
	</div>
	</div>
</body>
